...
struct VideoEditingResultView: View {
    
    @StateObject private var viewModel: VideoEditResultViewModel
    
    init(url: URL, router: Router, id: UUID) {
        _viewModel = StateObject(wrappedValue: VideoEditResultViewModel(url: url, router: router, id: id))
    }
